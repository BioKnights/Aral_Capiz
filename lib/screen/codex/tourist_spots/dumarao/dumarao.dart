...
import 'package:language_game/screen/codex/folklore/dumarao/dumarao_folklore.dart';
import 'package:language_game/services/animated_background.dart';

class DumaraoFolkloreScreen extends StatelessWidget {
  const DumaraoFolkloreScreen({super.key});

  static const _items = [
    {
      "title": "\"Araw\" Rice Variety",
      "image": "assets/images/dumarao_municipality.jpg",
      "screen": BigasVarietyScreen(),
    },
  ];
