...
import 'package:language_game/screen/codex/folklore/dumalag/dumalag_folklore.dart';
import 'package:language_game/services/animated_background.dart';

class DumalagFolkloreScreen extends StatelessWidget {
  const DumalagFolkloreScreen({super.key});

  static const _items = [
    {
      "title": "Bagsang",
      "image": "assets/images/man_silhouette.jpg",
      "screen": BagsangScreen(),
    },
  ];
