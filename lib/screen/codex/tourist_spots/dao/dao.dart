...
import 'package:language_game/screen/codex/folklore/dao/dao_tree.dart';
import 'package:language_game/services/animated_background.dart';

class DaoFolkloreScreen extends StatelessWidget {
  const DaoFolkloreScreen({super.key});

  static const _items = [
    {
      "title": "Dao Tree",
      "image": "assets/images/dao_municipality_(dao).jpg",
      "screen": PunoNgDaoScreen(),
    },
  ];
