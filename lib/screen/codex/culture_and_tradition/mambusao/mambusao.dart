...
import 'package:language_game/screen/codex/culture_and_tradition/mambusao/inilusan_festival.dart';
...
class MambusaoCultureScreen extends StatelessWidget {
  ...
  static const _items = [
    {
      "title": "Inilusan Festival",
      "image": "assets/images/inilusan_festival.jpg",
      "screen": InilusanFestivalScreen(),
    },
  ];
    ...
    return AnimatedBackground(
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Text("Mambusao Culture & Tradition"),
          centerTitle: true,
        ),
