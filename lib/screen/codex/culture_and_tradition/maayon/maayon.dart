...
import 'package:language_game/screen/codex/culture_and_tradition/maayon/maayon_festival.dart';
...
class MaayonCultureScreen extends StatelessWidget {
  ...
  static const _items = [
    {
      "title": "Hil-o Hil-o Festival",
      "image": "assets/images/hilo_hilo_festival.png",
      "screen": HiloHiloFestivalScreen(),
    },
  ];
    ...
    return AnimatedBackground(
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Text("Maayon Culture & Tradition"),
          centerTitle: true,
        ),
