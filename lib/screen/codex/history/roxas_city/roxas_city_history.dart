...
import 'package:language_game/screen/codex/history/roxas_city/roxas_city_origin.dart';
import 'package:language_game/widgets/tourist_spot_screen_card.dart';
import 'package:language_game/services/animated_background.dart';

class RoxasCityHistory extends StatelessWidget {
  const RoxasCityHistory({super.key});

  static const _items = [
    {
      "title": "Roxas City Origin",
      "image": "assets/images/roxas_cathedral.jpg",
      "screen": RoxasCityOrigin(),
    },
  ];
