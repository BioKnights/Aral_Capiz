...
import 'package:language_game/screen/codex/folklore/jamindan/jamindan_folklore.dart';
import 'package:language_game/services/animated_background.dart';

class JamindanFolkloreScreen extends StatelessWidget {
  const JamindanFolkloreScreen({super.key});

  static const _items = [
    {
      "title": "Bagsang",
      "image": "assets/images/jamindan.jpg",
      "screen": HamindangTreeScreen(),
    },
  ];
